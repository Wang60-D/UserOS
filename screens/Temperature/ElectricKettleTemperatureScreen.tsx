...
const ElectricKettleTemperatureScreen: React.FC = () => {
  const insets = useSafeAreaInsets();
  const [activeTab, setActiveTab] = useState<ElectricKettleTemperatureControlType>(0);
...
export default ElectricKettleTemperatureScreen;
