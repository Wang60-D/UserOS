...
const CountdownScreen: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<CountdownControlType>(0);
  const [delayMinutes, setDelayMinutes] = useState(80);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        ...
        <PageTabSwitch
          ...
          onChange={(index) => setActiveTab(index as CountdownControlType)}
          labels={[...VIEW_TABS]}
        />
      </View>
    </View>
