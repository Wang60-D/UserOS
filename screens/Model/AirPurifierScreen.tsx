...
const SEGMENT_MODE_CONFIG: Array<{
...
}> = [
  {
    key: 'auto',
    label: '自动',
    iconSelected: require('../../assets/icons/auto.png'),
    iconUnselected: require('../../assets/icons/auto.png'),
    iconSelectedTintColor: '#FFFFFF',
    iconUnselectedTintColor: '#000000CC',
  },
  {
    key: 'sleep',
    label: '睡眠',
    iconSelected: require('../../assets/icons/sleep.png'),
    iconUnselected: require('../../assets/icons/sleep.png'),
    iconSelectedTintColor: '#FFFFFF',
    iconUnselectedTintColor: '#000000CC',
  },
  {
    key: 'favorite',
    label: '最爱',
    iconSelected: require('../../assets/icons/favorite.png'),
    iconUnselected: require('../../assets/icons/favorite.png'),
    iconSelectedTintColor: '#FFFFFF',
    iconUnselectedTintColor: '#000000CC',
  },
  {
