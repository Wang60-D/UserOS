...
const INITIAL_POWER_VALUES = [false, false, true, true] as const;
const INITIAL_LIGHT_VALUES = [false, true, false, true] as const;
...
const BathLightScreen: React.FC = () => {
  ...
  const powerRowProps: DynamicRowProps =
    powerMode === 'switch'
      ...
      : {
          rightMode: 'icon',
          rightIconSource: BATH_ICONS.power,
  ...
  const lightRowProps: DynamicRowProps =
    lightMode === 'switch'
      ...
      : {
          rightMode: 'icon',
          rightIconSource: BATH_ICONS.light,
      ...
      <View style={styles.bottomSection}>
        ...
        <View style={styles.switchCard}>
          <SwitchRow
            ...
            leftIconSource={lightWithLeftIcon ? BATH_ICONS.light : undefined}
            rowHeight={TOKENS.sizes.switchCardHeight}
            containerBgColor="transparent"
            {...lightRowProps}
          />
...
export default BathLightScreen;
