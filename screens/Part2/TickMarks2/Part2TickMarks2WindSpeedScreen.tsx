...
const Part2TickMarks2WindSpeedScreen: React.FC = () => {
  const [value, setValue] = useState(40);

  return (
    <TickMarks2PageLayout
      imageSource={require('../../../assets/equipment/fan.png')}
      activeRoute="Part2TickMarks2WindSpeed"
    >
...
export default Part2TickMarks2WindSpeedScreen;
