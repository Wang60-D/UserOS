...
const Part2TickMarks2CurtainScreen: React.FC = () => {
  const [value, setValue] = useState(40);

  return (
    <TickMarks2PageLayout
      imageSource={require('../../../assets/equipment/curtain.png')}
      activeRoute="Part2TickMarks2Curtain"
    >
...
export default Part2TickMarks2CurtainScreen;
