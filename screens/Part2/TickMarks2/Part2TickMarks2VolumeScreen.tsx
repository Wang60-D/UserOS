...
const Part2TickMarks2VolumeScreen: React.FC = () => {
  const [value, setValue] = useState(30);

  return (
    <TickMarks2PageLayout
      imageSource={require('../../../assets/equipment/sound.png')}
      activeRoute="Part2TickMarks2Volume"
    >
...
export default Part2TickMarks2VolumeScreen;
