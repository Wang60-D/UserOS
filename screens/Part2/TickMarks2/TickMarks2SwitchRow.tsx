...
import { TICKMARKS2_ROUTES, type TickMarks2RouteName } from './TickMarks2Routes';

type Nav = StackNavigationProp<RootStackParamList>;

const TickMarks2SwitchRow: React.FC<{ activeRoute: TickMarks2RouteName }> = ({ activeRoute }) => {
  ...
  return (
    ...
    >
      ...
      >
        {TICKMARKS2_ROUTES.map((item, index) => (
          <View
            key={item.routeName}
...
export default TickMarks2SwitchRow;
