...
const Part2TickMarks3KettleTempScreen: React.FC = () => {
  const [value, setValue] = useState(45);

  return (
    <TickMarks3PageLayout
      imageSource={require('../../../assets/equipment/kettle.png')}
      activeRoute="Part2TickMarks3KettleTemp"
    >
...
export default Part2TickMarks3KettleTempScreen;
