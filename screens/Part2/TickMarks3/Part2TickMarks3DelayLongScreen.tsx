    ...
    >
      <View style={styles.modeCard}>
        ...
        <View style={styles.controlPanel}>
          <DotSlider
            value={value}
            onChange={(next) => setValue(clamp(Math.round(next / 5) * 5, 0, 320))}
            min={0}
            max={320}
            step={5}
            showDots={true}
...
export default Part2TickMarks3DelayLongScreen;
